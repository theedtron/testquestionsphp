            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('customers/post') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="min_amount" class="block mt-1 w-full" type="text" name="min_amount" :value="old('min_amount', $product->min_amount)" required autocomplete="min_amount" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="max_amount" class="block mt-1 w-full" type="text" name="max_amount" :value="old('max_amount', $product->max_amount)" required autocomplete="max_amount" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="interest_rate" class="block mt-1 w-full" type="text" name="interest_rate" :value="old('interest_rate', $product->interest_rate)" required autocomplete="interest_rate" />
